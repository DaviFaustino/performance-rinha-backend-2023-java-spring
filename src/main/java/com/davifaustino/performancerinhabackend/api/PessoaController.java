...
public class PessoaController {
    ...
    public Mono<ResponseEntity<Integer>> getContagemPessoas() {
        return pessoaService.getPessoasCounting().map(contagem -> ResponseEntity.status(HttpStatus.OK).body(contagem));
    }
}
